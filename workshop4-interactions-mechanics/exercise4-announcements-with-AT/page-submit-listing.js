              ...
              >
                ...
                <div className="two-parts-50-50">
                  <div className="form-field">
                    <label htmlFor="submittername">
                      Your name{" "}
                      <span className="asterisk" aria-label="required">
                        *
                      </span>
                    </label>
                    <input
                  ...
                  <div className="form-field">
                    ...
                    <input
                      aria-invalid={
                        isFormDirty && formState.email.length === 0
                          ? "true"
                          : null
                      }
                      id="email"
                ...
                <div className="two-parts-50-50">
                  <div className="form-field">
                    ...
                    <input
                      aria-invalid={
                        isFormDirty && formState.sitename.length === 0
                          ? "true"
                          : null
                      }
                      id="sitename"
                  ...
                  <div className="form-field">
                    ...
                    <input
                      aria-invalid={
                        isFormDirty && formState.location.length === 0
                          ? "true"
                          : null
                      }
                      id="location"
